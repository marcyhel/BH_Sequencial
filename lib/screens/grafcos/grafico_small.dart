...
import 'package:bh_sequencial/screens/grafcos/widget/card_graf_small.dart';
...
class Graficos_small extends StatelessWidget {
  const Graficos_small({Key? key}) : super(key: key);
